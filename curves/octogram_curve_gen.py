    ...
    def execute(self, context):
        ...
        if sub_type == "INVERSE":
            points = [
                ...
                (0.29289321881345237, 0.29289321881345237, 0.0), # 2 Top right
                (0.29289321881345237, 0.7071067811865476, 0.0),
                (0.0, 1.0, 0.0), # 4 Top center
                (-0.29289321881345237, 0.7071067811865476, 0.0),
                (-0.29289321881345237, 0.29289321881345237, 0.0), # 6 Top left
                (-0.7071067811865476, 0.29289321881345237, 0.0),
                (-1.0, 0.0, 0.0), # 8 Center left
                (-0.7071067811865476, -0.29289321881345237, 0.0),
                (-0.29289321881345237, -0.29289321881345237, 0.0), # 10 Bottom left
                (-0.29289321881345237, -0.7071067811865476, 0.0),
                (0.0, -1.0, 0.0), # 12 Bottom center knot
                (0.29289321881345237, -0.7071067811865476, 0.0),
                (0.29289321881345237, -0.29289321881345237, 0.0), # 14 Bottom right
                (0.7071067811865476, -0.29289321881345237, 0.0),
            ]
